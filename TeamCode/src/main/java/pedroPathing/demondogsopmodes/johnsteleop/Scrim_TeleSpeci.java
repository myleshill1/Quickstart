...
@TeleOp
public class Scrim_TeleSpeci extends LinearOpMode {
    @Override
...
//            }
            ...
            if (gamepad2.y) {
                ...
                Lpivot.setTargetPosition(-210);
                Rpivot.setTargetPosition(-210);
            ...
            if (timer.seconds() >= 0.4 && zero == true ) {
            ...
            if (gamepad2.b){
                ...
                Lpivot.setTargetPosition(-275);
                Rpivot.setTargetPosition(-275);
            ...
            if(timer.seconds() >= 1.5 && grabSpecimen == true){
            ...
            if(timer.seconds() >= 3 && grabSpecimen == true && claw.getPosition() < 0.4){


                Lpivot.setTargetPosition(-550);
                Rpivot.setTargetPosition(-550);
            ...
            if(gamepad2.x){
                ...
                Lpivot.setTargetPosition(-1600);
                Rpivot.setTargetPosition(-1600);
            ...
            if(timer.seconds() > 0.5 && scoreSpecimen == true){

                Lslides.setTargetPosition(300);
                Rslides.setTargetPosition(300);
            ...
            if(timer.seconds() > 2 && scoreSpecimen == true){

                clawPivot.setPosition(0.8);

                Lpivot.setTargetPosition(-1950);
                Rpivot.setTargetPosition(-1950); 
            ...
            if (timer.seconds() > 2.5 && scoreSpecimen == true){
